...
} = require('../Controllers/DistrictCouncilController')
...
router.patch('/district-council/:councilId/assign-officer', authMiddleware, assignOfficerToCouncil);
router.post('/district-council/:councilId/add-employee', authMiddleware, addEmployeeToCouncil);
router.delete('/district-council/:councilId/employee/:employeeId', authMiddleware, removeEmployeeFromCouncil);
